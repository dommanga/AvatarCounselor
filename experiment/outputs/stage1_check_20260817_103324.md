...
## p4_q1
- distinct score-patterns: **3**
- modal agreement: **6/10**
- modal scores: `{"result": 0, "situation": 2, "task_and_action": 2}`
    - 6x  `{"result": 0, "situation": 2, "task_and_action": 2}`
    - 3x  `{"result": 0, "situation": 1, "task_and_action": 1}`
    - 1x  `{"result": 1, "situation": 2, "task_and_action": 2}`

<details><summary>sample raw</summary>

```json
{
  "SITUATION":       {"rating": 1, "quote": "in a class project we had, like, four people, and two of us wanted to do the topic on, uh, renewable energy and the other two wanted something about AI"},
  "TASK_AND_ACTION": {"rating": 1, "quote": "I kind of pushed for the energy one, like I sent some example papers to show it's, uh, more doable"},
...
- modal scores: `{"result": 2, "situation": 1, "task_and_action": 0}`
    - 10x  `{"result": 2, "situation": 1, "task_and_action": 0}`

<details><summary>sample raw</summary>

```json
{
  "SITUATION":       {"rating": 1, "quote": "in our department there was, uh, no proper place for students to find like past exam papers"},
